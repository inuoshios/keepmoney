...
router
  .route('/budget/:budgetId/transactions')
  .post(
    requireUser,
    validate(createTransactionSchema),
    async (
      req: Request<
        CreateTransactionInput['params'],
        {},
        CreateTransactionInput['body']
      >,
      res: Response
    ) => {
...
router
  .route('/budget/:budgetId/transactions/:transactionId')
  .get(
    requireUser,
    validate(getSingleTransactionSchema),
    async (
      req: Request<getSingleTransactionParams['params']>,
      res: Response
    ) => {
  ...
  .patch(
    ...
    async (
      ...
      res
        ...
        .json({ msg: 'success', transaction: updateTrnx });
    }
  )
  .delete(
    requireUser,
